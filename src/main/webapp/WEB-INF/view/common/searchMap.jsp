...
<head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA6LMLFhm45uEvk6eaXBl5VbVkoJUPnaAo&libraries=places"></script>
</head>
<body>


<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=41d534ae5dc3fb8670ff2f84bd5cf770&libraries=services"></script>
<script>
    // 마커를 담을 배열입니다
    var markers = [];
